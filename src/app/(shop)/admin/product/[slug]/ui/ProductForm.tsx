...
// Redirigir al producto creado/actualizado si quieres
...
return ( <form
 ...
 >
{/* Textos */} <div className="w-full"> <div className="flex flex-col mb-2"> <span>Título</span>
<input
type="text"
...
```
    ...
    {successMessage && (
      <div className="bg-green-100 text-green-800 p-2 mb-2 rounded-md">
        {successMessage}
      </div>
    )}
